...
public class EgovUserController {
    ...
    public String selectTemplateInfs(@ModelAttribute("searchVO") UserVO vo, ModelMap model) throws Exception {
    	...
    	List<UserVO> list = egovUserService.selectUserList(vo);
    	
    	model.addAttribute("list", list);

		return "cop/com/EgovUserList";
    }
